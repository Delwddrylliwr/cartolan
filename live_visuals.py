...
class GameVisualisation():
    ...
    CARD_TEXTS = {"adv+agents":"Place and immediately rest with Agents on existing tiles, for 3 treasure."
             ...
             , "adv+downwind":"Up to four moves riding the wind once tired, each turn and after resting."
             , "adv+upwind":"Three moves in any direction before getting tired, and one riding the wind, each turn or after resting."
             ...
             , "dis+bank":"Treasure can be transferred to own Agents when visiting anyone's Agent."
             ...
             , "dis+downwind":"Two more moves riding the wind after tiring, each turn and after resting."
             , "dis+upwind":"One more move in any direction before tiring, rather than after tiring, each turn and after resting."
             , "dis+maps":"Carry an extra map tile in the chest."
             , "com+rests":"Adventurers can rest with others' Adventurers. Draw 3 Adventurers."
            ...
            , "com+arrest":"Agents try to arrest pirates landing on their tile. Draw 3 Adventurers."
            , "com+refurnish":"The pirate token can be lost by resting. Draw 3 Adventureres."
            , "com+pool":"Maps can be swapped at Agents for 1 treasure. Draw 3 Manuscript cards."
            }
