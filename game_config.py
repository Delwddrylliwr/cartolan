...
'''
from base import Tile, WonderTile
from Beginner import CapitalTileBeginner, CityTileBeginner, AdventurerBeginner, AgentBeginner
from Regular import CapitalTileRegular, MythicalTileRegular, DisasterTile, CityTileRegular, AdventurerRegular, AgentRegular
